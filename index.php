	...
	<div class="content">
		<div class="clearfix">
			<div class="hero1 hero indexHero1">
				<div class=textContainer>
					<h1><span class="pink">Ne</span>w Dad <span class="pink">St</span>udy </h1>
					<h2> NEST's research aims to improve support for the mental health and wellbeing of new fathers in the UK. You may find the links to additional resources and helplines useful in the resources section.</h2>
					<a href="resources.html" class="button">CLICK HERE</a>
				</div>
			</div>
		</div>
		<div class="firstBar clearfix infoBar">
			<div class="firstBarText">
				...
				<h2>Nest's Purpose at a Glance</h2>
